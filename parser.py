...
def extract_answer(pred_str, data_name, use_last_number=True):
    ...
    if data_name in ["mmlu_stem", "sat_math", "aqua", "gaokao2023", "gpqa", "commonsenseqa"]:
...
def parse_ground_truth(example: Dict[str, Any], data_name):
    if "gt_cot" in example and "gt" in example:
        if data_name in ["math", "math_hard", "math500", "PDSet"]:
    ...
    # parse ground truth
    if data_name in ["math", "minerva_math", "math_hard", "math500", "PDSet"]:
